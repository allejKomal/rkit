...
const components = [
  {
    ...
    description: 'Simple testimonial with quote and author info',
  },
  {
    component: TestimonialWithRating,
    title: 'Testimonial with Rating',
    description: 'Testimonial with star rating and detailed feedback',
  },
  {
    component: TestimonialCard,
    title: 'Testimonial Card',
    description: 'Card-style testimonial with enhanced design',
  },
  {
    component: TestimonialSimple,
    title: 'Simple Testimonial',
    description: 'Minimal testimonial design focused on content',
  },
];
