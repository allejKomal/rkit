...
const components = [
  {
    ...
    description: 'Simple form with standard input fields',
  },
  {
    component: FormLayoutTwoColumn,
    title: 'Two Column Form',
    description: 'Form layout with two columns for better space usage',
  },
  {
    component: FormLayoutWizard,
    title: 'Wizard Form',
    description: 'Multi-step form with progress indicator',
  },
  {
    component: FormLayoutCompact,
    title: 'Compact Form',
    description: 'Compact form layout for limited space',
  },
  {
    component: FormLayoutAdvanced,
    title: 'Advanced Form',
    description: 'Advanced form with validation and custom fields',
  },
];
