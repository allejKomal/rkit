...
const components = [
  {
    component: FAQBasic,
    title: 'Basic FAQ Accordion',
    description: 'Simple FAQ with expandable answers',
  },
  {
    component: FAQStyled,
    title: 'Styled FAQ Section',
    description: 'FAQ with custom styling and icons',
  },
  {
  ...
  {
    component: FAQAdvanced,
    title: 'Advanced FAQ',
    description: 'Advanced FAQ with multiple features',
  },
];
