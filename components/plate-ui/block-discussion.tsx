...
} from '@/components/plate-ui/block-suggestion';
import { Comment, CommentCreateForm } from '@/components/plate-ui/comment';
import { commentPlugin } from '@/components/plate/comment-kit';
import { type TDiscussion, discussionPlugin } from '@/components/plate/discussion-kit';
...
export const BlockDiscussion: RenderNodeWrapper<AnyPluginConfig> = props => {
  ...
  const InnerBlockDiscussion = (props: PlateElementProps) => (
    <BlockCommentContent
      blockPath={blockPath}
  ...
  InnerBlockDiscussion.displayName = 'InnerBlockDiscussion';

  return InnerBlockDiscussion;
};
