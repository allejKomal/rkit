...
const TeamWithRolesPage = () => {
  return (
    <div className="flex flex-col justify-center max-w-(--breakpoint-xl) mx-auto">
      <b className="text-muted-foreground font-semibold text-sm uppercase">Our team</b>
...
export default TeamWithRolesPage;
