import { Bolt, ExternalLink, Filter, LogIn, LogOut, Rocket, Settings2, User } from 'lucide-react';
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="mt-2 w-72">
        ...
        <DropdownMenuItem className="flex-col items-start">
          ...
          <p className="text-muted-foreground">You&apos;re on a free version of Slack.</p>
        </DropdownMenuItem>
        <DropdownMenuSeparator />
        <DropdownMenuItem>
        ...
        <DropdownMenuSub>
          ...
          <DropdownMenuSubContent>
            <DropdownMenuSub>
              ...
              <DropdownMenuSubContent>
                <DropdownMenuCheckboxItem checked>All activity</DropdownMenuCheckboxItem>
                <DropdownMenuCheckboxItem>Unread messaged only</DropdownMenuCheckboxItem>
                <DropdownMenuCheckboxItem>Mentions only</DropdownMenuCheckboxItem>
                <DropdownMenuCheckboxItem>Customize by section</DropdownMenuCheckboxItem>
              </DropdownMenuSubContent>
            </DropdownMenuSub>
            <DropdownMenuSub>
              ...
              <DropdownMenuSubContent>
                ...
                <DropdownMenuCheckboxItem>Without external people</DropdownMenuCheckboxItem>
                <DropdownMenuCheckboxItem>Including external people</DropdownMenuCheckboxItem>
              </DropdownMenuSubContent>
            </DropdownMenuSub>
          </DropdownMenuSubContent>
        </DropdownMenuSub>
