...
export function DataTablePagination<TData>({ config, table }: DataTablePaginationProps<TData>) {
  return (
    <div className="flex items-center justify-between border rounded-md px-4 py-2">
      ...
      <div
        className={cn(
          'flex items-center space-x-6 lg:space-x-8 w-full',
          !config?.enableMultiRowSelection && 'justify-between',
          config?.enableMultiRowSelection && 'justify-end'
        )}
      >
