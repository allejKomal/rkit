...
export default function CardGridBasic() {
  return (
    <div className="flex items-center justify-center p-8">
      <div>
        <h2 className="text-sm font-medium text-muted-foreground">Favorite Book Collections</h2>
              ...
              <Card className="flex flex-row w-full gap-0 rounded-md shadow-sm overflow-hidden py-0">
                ...
                <CardContent className="flex  flex-1 items-center justify-between truncate p-0 bg-card">
                  <div className="flex-1 truncate px-4 py-2 text-sm">
                    ...
                    <p className="text-muted-foreground">{collection.books} Books</p>
                  </div>
