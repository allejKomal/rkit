        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <DialogHeader>
            ...
            <DialogDescription className="sm:text-center">
              {hasGuessed ? (
                <span>
                  Congratulations! your email account <strong>exa**le@gmail.com</strong> has been
                  verified
                </span>
              ) : (
                <span>
                  We have sent a verification code to <strong>exa**le@gmail.com</strong>. Please
                  check your inbox and input the code below to activate your account. Try{' '}
                  {CORRECT_CODE}
                </span>
              )}
            </DialogDescription>
