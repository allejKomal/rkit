...
function TimelineMinimalItem({ title, description, icon, index }: TimelineMinimalItemProps) {
  return (
...
export { TimelineMinimal, TimelineMinimalItem };
