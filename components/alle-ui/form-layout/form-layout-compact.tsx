...
export default function FormLayoutCompact() {
  const [selectedWorkspace, setSelectedWorkspace] = useState(workspaces[0]);

  return (
    <div className="flex items-center justify-center p-10">
      <div className="sm:mx-auto sm:max-w-2xl">
        <h3 className="text-lg font-semibold text-foreground">Apply for early access</h3>
              ...
              <RadioGroup
                ...
                onValueChange={value =>
                  setSelectedWorkspace(
                    workspaces.find(workspace => workspace.id.toString() === value) || workspaces[0]
                  )
                }
              >
                {workspaces.map(item => (
